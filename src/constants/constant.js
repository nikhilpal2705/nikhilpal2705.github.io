...
export const portfolioData = {
    ...
    filters: [{ name: "App", class: 'filter-app' }, { name: "Card", class: 'filter-product' }, { name: "Web", class: 'filter-branding' }],
    portfolioItems: [
...
export const servicesData = {
    mainSummary: " Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodiquidem hic quas.",
    services: [
        {
            icon: 'bi bi-activity',
            title: 'Nesciunt Mete',
